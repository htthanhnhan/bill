<template>
  <b-navbar data-cy="navbar" toggleable="md" type="dark" class="jh-navbar">
    <b-navbar-brand class="logo" b-link to="/">
      ...
      <span v-text="$t('global.title')" class="navbar-title">BillManager</span> <span class="navbar-version">{{ version }}</span>
    </b-navbar-brand>
    <b-navbar-toggle
      right
    ...
    <b-collapse is-nav id="header-tabs">
      <b-navbar-nav class="ml-auto">
        ...
        <b-nav-item-dropdown right id="entity-menu" v-if="hasAnyAuthority('ROLE_ADMIN') && authenticated" active-class="active" class="pointer" data-cy="entity">
          ...
          <b-dropdown-item to="/bill">
            <font-awesome-icon icon="asterisk" />
            <span v-text="$t('global.menu.entities.bill')">Bill</span>
          </b-dropdown-item>
        ...
        >
          <span slot="button-content" class="navbar-dropdown-menu">
            ...
            <span class="no-bold" v-if="!authenticated" v-text="$t('global.menu.account.main')"> Account </span>
            <span class="no-bold" v-else> {{ username }} </span>
          </span>
