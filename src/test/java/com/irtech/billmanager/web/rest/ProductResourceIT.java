...
class ProductResourceIT {
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product().name(DEFAULT_NAME).quantity(DEFAULT_QUANTITY).price(DEFAULT_PRICE);
        return product;
    }
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product().name(UPDATED_NAME).quantity(UPDATED_QUANTITY).price(UPDATED_PRICE);
        return product;
    }
    ...
    void putNewProduct() throws Exception {
        ...
        updatedProduct.name(UPDATED_NAME).quantity(UPDATED_QUANTITY).price(UPDATED_PRICE);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.name(UPDATED_NAME).quantity(UPDATED_QUANTITY).price(UPDATED_PRICE);
